...
const TestimonialSection = () => {
    return (
        <div className="container card testimonial-card mb-5 mt-5">
            <div className="card-body my-3 p-4 row gy-4 border-secondary">
                ...
                <div className='row mt-3 d-flex justify-content-between px-3'>
                    <AudioPlayer />
                    <div className="d-flex align-items-center justify-content-end col ms-auto">
                        <img src="Thumnail.svg" alt="Shubha Nagarajan" className="rounded-circle me-3" width="50" height="50" />
                        <div>
...
function AudioPlayer() {
    return (
        <div className="d-flex align-items-center col-9 rounded py-4 px-5" style={{ backgroundColor: '#CCC1DA' }}>
